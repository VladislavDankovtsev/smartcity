...
public interface AgriculureRepository extends JpaRepository<Agriculture, UUID> {
    @Query("select s from Agriculture s where s.time between :fromD and :toD")
    List<Agriculture> getAgrigultureForDate(@Param("fromD") LocalDateTime fromD, @Param("toD") LocalDateTime toD);
